# Generated by Django 4.1 on 2022-09-29 11:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.IntegerField(null=True, validators=[django.core.validators.MaxValueValidator(limit_value=60, message='Максимум 60'), django.core.validators.MinValueValidator(limit_value=5, message='Минимум 5')], verbose_name='Возраст')),
                ('is_student', models.CharField(choices=[('teacher', 'Учитель'), ('student', 'Ученик')], max_length=30, verbose_name='Я')),
